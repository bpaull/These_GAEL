...
<!-- I just changed the order of stuff and the position of the new paragraph because else the second characteristics was lost after the footnote and in another paragraph, and it was hard to follow (it's an old point really, already discussed beteen us) -->
...
temptation models.
<!-- this following sentence "I therefore propose" is a bit out of place since it focuses on ONE chapter only, and here you are describing the full thesis; consider removing it or changin it so that it is not so alien in between paragraphs that talk of the thesis as a whole (above) or of the individual chapters (below) -->
...
My master thesis consisted in a model that extended the @fudenberg2006dual individual-choice model to two individuals, each composed of two selves and having to decide on the distribution of a budget when their choices 
...
interactions.
<!-- Houser: I do not understand why you choose to focus on the subjects who behaved like ours i.e. refuse to pay and keep performing. It is confusing. Tell us how many subjects switched to surfing and how many paid for costly commitment instead. -->
<!-- consider adding a simple and direct expalantion sentence as "Since no-one was tempted and no-one asked for any sort of costly commitment, we had no way of testing how strategic interactions affected a non-existent temptation". Or similar; just to drive the point home in clear, non technical language -->
...
<!-- acthung! in the bookdown website you count the intro as its own chapter;I mean, intro + chpt 1, 2, 3? Right now you have intro = 1 and so chpt 1 is 2 etc... minor point, but a bit annoying. maybe bookdown can be forced to have intro be counted as 0 or not counted? -->
...
binding or not.
<!-- I ee you do not mention (probably on purpose) soft vs hard commitment. IF you want to introduce this temrs, maybe here is the right place to do so. -->
...
There exists works, like @ert2017revisiting, that take multiple measures of risk (here using a Holt and Laury task) but don't 
compute variability; and works like @wilcox2007predicting that compute estimation 
...
<!-- consistency: if you say "chapter 3" then say "chapter 4" and not "fourth chapter"; and see above for numbering. -->
...
underestimation of the risk of the first type
<!-- not understandable. "Type-I risk" != "risk of the first type"; and again be clearer. -->
, and on the other hand by 
recurring as little as possible to individual level estimations.
<!-- the part below is crucial: it shows that you did rethink the whole stat analysis of chpt 1 and 2 after chpt 3 results were in. Be more open about it and clearer, it is not so easy to follow now; me, I know; but the other readers won't. A simple sentence that says "the results of chpt 3 forced me to change my stat approach to the other chapters, because of the instability and blah blah. As a consequence I (changes for Chpt3), and 'changes for chpt 2).  -->
