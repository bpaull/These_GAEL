...
For example, the demand for a costly commitment (XXXX), the exercise of self-control (YYYY) or the choice of subscriptions inconsistent with the use of a service [@dellavigna2006paying]. 
