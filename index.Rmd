...
This approach was initiated by KREPS1979. 
...
For example, the demand for a costly commitment (XXXX), the exercise of self-control (YYYY) or the choice of subscriptions inconsistent with the use of a service (DELAMAL2006). 
...
(the reader who wants to be convinced can consult the literature review on the subject GULLIP2011), but the experimental literature on the subject does not propose a design allowing to compare these models;
...
it induces first by MARSHMALREF and then in XXXX, the preference for a 
restricted set of choices in TOUSSAERT2018 and the demand for an expensive 
commitment in HOUSER2018. 
...
notably those of GP2001 and FL2006, to take into account the combined effects of temptation and strategic interactions. 
The original PhD thesis project was based on work carried out for my master thesis. 
My master thesis consisted in a model that adapted the FL2006 model for two individuals, each composed of two selves and having to decide on the distribution of a budget where their choice 
...
the second chapter <!-- ADD HERE title, and/or cross-reference to the chapter -->, 
...
preferences which is described in the third chapter of this thesis. <!-- again, add title and cross-reference --> 
...
I chose to rename my thesis NEWTITLE. 
